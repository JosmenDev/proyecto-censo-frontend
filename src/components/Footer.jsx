const Footer = () => {
    return (
        <>
            <footer className="bg-white dark:bg-boxdark border-t dark:border-none border-stroke dark:border-zink-600 relative w-full px-4 h-14 flex items-center justify-between py-3 shadow-default">
