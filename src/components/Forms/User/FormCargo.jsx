    ...
    import { clearCargo, guardarCargo } from '../../../redux/User/CargoSlice';
    ...
    const FormCargo = () => {
        ...
        const { cargo, loading, error } = useSelector((state) => state.cargo);
        ...
        const onSubmit = async formData => {
            dispatch(guardarCargo(formData));
            reset();
        }
                    ...
                    <div className="p-6.5">
                        ...
                        <div className="mb-4.5 flex flex-col gap-6 xsm:flex-row">
                            <button 
                                ...
                                disabled={loading}
                            >
                                {loading ? "Guardando..." : cargo ? "Actualizar" : "Guardar"}
                            </button>
                            <button 
                                type="button"
                                onClick={() => {
